...
The study was presented to participants as an evaluation of cognitive functions through a computer-based "game" accompanied by additional questionnaires. 
...
The main objective of this study was to employ computational models of reinforcement learning to analyze and compare the learning outcomes within two distinct contextual conditions: decision-making involving disorder-relevant information and decision-making without disorder-relevant information.

We used a reinforcement learning drift diffusion model [RLDDM; @pedersen2020simultaneous] to investigate the impact of disorder-related information, which is irrelevant to the outcome, on decision-making. The RLDDM consists of two key components: one describes how reward feedback is employed to update value expectations and the other describes how an agent uses these expectations to arrive at a decision.
